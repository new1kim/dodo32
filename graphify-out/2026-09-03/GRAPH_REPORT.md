...
## Corpus Check
- 14 files · ~66,343 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 192 nodes · 372 edges · 15 communities (12 shown, 3 thin omitted)
...
Cohesion: 0.07
Nodes (27): ageInput, applyRateCheck, baseDeclareAmountInput, baseDeclareConvertedOutput, baseDeclareInputGroup, baseDeclareTypeRadios, baseEstimateLabel, baseIncomeInput (+19 more)

### Community 1 - "What You Must Do When Invoked"
Cohesion: 0.07
Nodes (26): For /graphify add and --watch, For /graphify query, For the commit hook and native CLAUDE.md integration, For --update and --cluster-only, /graphify, Honesty Rules, Interpreter guard for subcommands, Part A - Structural extraction for code files (+18 more)

### Community 2 - "applyOtherRowsBlock"
Cohesion: 0.20
Nodes (21): applyBaseIncomeMode(), applyIncomeRowMode(), applyOtherRowsBlock(), bindRadioToggleGroup(), buildIncomeRowHTML(), calcDeclareConvertedIncome(), getRowEls(), isOtherIncomeBlocked() (+13 more)
...
### Community 8 - "showBubble"
Cohesion: 0.16
Nodes (19): applyDefaultProfileToRow(), bindLongPress(), bindMortgageRowEvents(), closeModal(), extraIncomeRowIndexes(), fallbackCopyText(), getDefaultProfileValues(), getStoredJson() (+11 more)
...
- **Why does `fitAllNumericInputFontSizes()` connect `fitAllNumericInputFontSizes` to `DSR_calculator_ui.js`, `init`, `DSR_calculator_logic.min.js`, `showBubble`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `adjustTableFontSize()` connect `init` to `DSR_calculator_ui.js`, `showBubble`, `applyOtherRowsBlock`, `DSR_calculator_logic.min.js`?**
