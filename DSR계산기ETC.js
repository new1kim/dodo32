/* DSR계산기ETC - 그 외 코드 (UI, 이벤트, 모달, 로컬스토리지 등) */
    ...
    /* DSR 한도금액 클릭 시 본건 대출원금 입력칸에 세팅해주는 함수 (10만 단위 절삭 및 repayment type 적용) */
    ...
    function loadDSRInputs() {
      ...
      // Synchronously load mortgage rows so calculations include added rows immediately after refresh
      loadMortgageRows();
    }
